...
namespace SeaPeaYou.PeaPdf
{
    class PdfWriter : ByteWriter
    {
        ...
        public bool NeedsDeliminator { get; set; }
        public int? IndentLevel { get; set; }

        readonly byte[] encryptionKey;
        readonly bool encryptionUseRC4;

        public PdfWriter(byte[] encryptionKey = null, bool encryptionUseRC4 = false, bool prettyPrint = false)
        {
        ...
        public void Indent()
        {
            ...
            if (IndentLevel is int indentLevel && (Count == 0 || PeekByte == '\n'))
